class Google::RestaurantsController < ApplicationController
  ...
  def show
    response = RestClient::Request.execute(
      method: :get,
      url: "https://maps.googleapis.com/maps/api/place/details/json?placeid=#{params[:place_id]}&fields=name,rating,formatted_phone_number,user_ratings_total,formatted_address,opening_hours,website,photos&key=AIzaSyD9XLOcSAh_iiObVToMVQ8Wdud0xPjhGbo",
     headers: {api_key: 'AIzaSyD9XLOcSAh_iiObVToMVQ8Wdud0xPjhGbo'}
      )
